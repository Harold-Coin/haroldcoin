...
In order to support loading of multiple wallets in haroldcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is haroldcoin.cpp.
...
Changes to haroldcoin.cpp
----------------------
haroldcoin.cpp is the entry point into haroldcoin-qt, and as such, will require some minor modifications to provide hooks for
