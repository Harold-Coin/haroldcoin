...
/** Utility functions used by the haroldcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render haroldcoin addresses in monospace font
...
// Parse "haroldcoin:" URI into recipient object, return true on successful parsing
