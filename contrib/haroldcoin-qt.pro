...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/haroldcoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/haroldcoin-cli.cpp \
           src/haroldcoin-tx.cpp \
           src/haroldcoin.cpp \
           src/db.cpp \
           ...
           src/qt/haroldcoin.cpp \
           src/qt/haroldcoinstrings.cpp \
...
RESOURCES += src/qt/haroldcoin.qrc src/qt/haroldcoin_locale.qrc

TRANSLATIONS += src/qt/locale/haroldcoin_bg.ts \
                src/qt/locale/haroldcoin_de.ts \
                src/qt/locale/haroldcoin_en.ts \
                src/qt/locale/haroldcoin_es.ts \
                src/qt/locale/haroldcoin_fi.ts \
                src/qt/locale/haroldcoin_fr.ts \
                src/qt/locale/haroldcoin_it.ts \
                src/qt/locale/haroldcoin_ja.ts \
                src/qt/locale/haroldcoin_pl.ts \
                src/qt/locale/haroldcoin_pt.ts \
                src/qt/locale/haroldcoin_ru.ts \
                src/qt/locale/haroldcoin_sk.ts \
                src/qt/locale/haroldcoin_sv.ts \
                src/qt/locale/haroldcoin_vi.ts \
                src/qt/locale/haroldcoin_zh_CN.ts \
                src/qt/locale/haroldcoin_zh_TW.ts
